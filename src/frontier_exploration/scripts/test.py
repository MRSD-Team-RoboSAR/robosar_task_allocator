...
plt.plot(point[0]-0.5, point[1]-0.5, marker='o', color='red', markersize=20, label=str(ig))
rect = patches.Rectangle([point[0]-r-0.5, point[1]+r-0.5], 2*r, -2*r, edgecolor='green', fill=False, linewidth=2)
ax.add_patch(rect)
plt.show()